...
import { Bot, LayoutDashboard, LibraryBig, LogOut, PanelLeft, Search } from "lucide-react";
            ...
            <div className="flex items-center gap-3 px-2 transition-all w-full">
              ...
              {!isCollapsed ? (
                <div className="flex items-center gap-2 min-w-0">
                    <span className="font-semibold tracking-[0.16em] uppercase text-xs truncate">
                      VV API
                  </span>
                </div>
              ) : null}
